...
app.http('getFeedLogs', {
  ...
  handler: async (request) => {
    try {
      ...
      return errorResponse(error, 'Failed to fetch feed logs');
    }
  }
});
...
app.http('createFeedLog', {
  ...
  handler: async (request) => {
    try {
      ...
      return errorResponse(error, 'Failed to create feed log');
    }
  }
});
...
app.http('deleteFeedLog', {
  ...
  handler: async (request) => {
    try {
      ...
      return errorResponse(error, 'Failed to delete feed log');
    }
  }
});
